...
<head>
    ...
    <title>@yield('title', 'Dashboard P2')</title>
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    <a href="{{ route('p2.dashboard') }}" class="flex items-center gap-2">
                        ...
                        <span class="font-bold tracking-tight text-lg hidden md:block">P2 PANEL</span>
                    </a>
                </div>
                ...
                <div class="hidden sm:flex items-center gap-4">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <div class="block px-4 py-2 text-xs text-gray-400">Role: Pimpinan (P2)</div>
